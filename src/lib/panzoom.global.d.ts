declare module "panzoom" {
    ...
    export interface PanZoom {
        ...
        smoothZoomAbs: (clientX: number, clientY: number, toScaleValue: number) => void;
    ...
    export default function createPanZoom(domElement: HTMLElement | SVGElement, options?: PanZoomOptions): PanZoom;
}
