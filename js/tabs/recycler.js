    ...
    updateButtons() {
        SharkGame.ResourceMap.forEach((_resource, resourceName) => {
            if (res.getTotalResource(resourceName) > 0) {
                ...
                label += sharktext.getResourceName(resourceName, disableButton, buy, sharkcolor.getElementColor("input-" + resourceName, "background-color"));
                ...
                label += sharktext.getResourceName(resourceName, disableButton, buy, sharkcolor.getElementColor("output-" + resourceName, "background-color"));
